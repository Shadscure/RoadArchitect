...
public final class RAConfigForgeBridge {
    ...
    private static ForgeConfigSpec.IntValue CACHE_MAX_SIZE;
    ...
    private static void setupConfig(ForgeConfigSpec.Builder builder) {
        ...
        CACHE_MAX_SIZE = builder
                .comment("Maximum size of the structure selector cache")
                .defineInRange("cacheMaxSize", 50000, 0, 500000);
    }
}